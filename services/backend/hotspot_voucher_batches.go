...
func registerHotspotVoucherBatchRoutes(mux *http.ServeMux, admin *administrator, db *sql.DB, audit *auditClient) {
	mux.HandleFunc("GET /api/hotspot/voucher-batches", requireSession(admin, func(w http.ResponseWriter, r *http.Request) {
	...
	mux.HandleFunc("GET /api/hotspot/voucher-batches/{id}", requireSession(admin, func(w http.ResponseWriter, r *http.Request) {
	...
	mux.HandleFunc("POST /api/hotspot/vouchers", requireSession(admin, func(w http.ResponseWriter, r *http.Request) {
