...
func registerHotspotLogsRoutes(mux *http.ServeMux, worker *workerClient, admin *administrator, audit *auditClient, db *sql.DB) {
	...
	mux.HandleFunc("POST /api/hotspot/logs/clear", requireSession(admin, func(w http.ResponseWriter, r *http.Request) {
