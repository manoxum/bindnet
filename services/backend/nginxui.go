...
func registerNginxUIRoutes(mux *http.ServeMux, admin *administrator) {
	mux.HandleFunc("GET /api/nginx-ui/install-secret", requireSession(admin, func(w http.ResponseWriter, r *http.Request) {
