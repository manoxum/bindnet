...
// Fieldsets de taxa/cota/throttle compartilhados por HotspotLimitsForm
// (limite global/por dispositivo) e HotspotProfileForm (perfil) - os
// dois usam exatamente os mesmos nomes de campo
// (hotspot-limits-schema.ts), so muda o que o formulario pai faz no
// submit. register/errors ficam frouxamente tipados (UseFormRegister<any>)
// de proposito, ja que este fieldset e reusado por schemas zod
// diferentes que so compartilham esse subconjunto de campos.
